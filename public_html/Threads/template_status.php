...
if($isOwner == "yes"){
    ...
    $status_ui = '<textarea style="resize: none; height: 100px;" class="bigtext" id="statustext" rows="5" cols="50" onkeyup="statusMax(this,250)" placeholder="Start a new thread."></textarea>';
            ...
            if(ajaxReturn(ajax) == true) {
                ...
                if(datArray[0] == "post_ok"){
                    ...
                    _("statusarea").innerHTML = '<div id="status_'+sid+'" class="status_boxes">' +
                        ...
                        '<span id="sdb_'+sid+'">' +
                        '<a href="#" onclick="return false;" onmousedown="deleteStatus(\''+sid+'\',\'status_'+sid+'\');" title="DELETE THIS STATUS AND ITS REPLIES">' +
                        ' delete comment' +
                        '</a>' +
                        '</span></div>' +
                        '<br />' +
                        ...
                        '</div>' +
                        '</div>' +
                        '<hr><textarea style="resize: none; margin-left: 15px; height: 100px;" class="bigtext"" rows="5" cols="50" onkeyup="statusMax(this,250)" placeholder="Write a reply">' +
                        '</textarea>' +
                        '<br>' +
            ...
            if(ajaxReturn(ajax) == true) {
                ...
                if(datArray[0] == "reply_ok"){
                    ...
                    _("status_"+sid).innerHTML +=
                        ...
                        '<br>' +
                        '<b class="bigtext" style="margin-left: 15px">'+data+'</b>' +
                        '<br>' +
                        '<div style="margin-left: 15px">' +
