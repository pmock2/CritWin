    ...
    <header><!-- HEADER STARTS HERE-->
        <div class='container titles yomer-text-center'>
            ...
            <div class='subhead'>
                ...
                <div style="padding-top: 150px" class="fb-like" data-href="https://facebook.com/critwin"
                     data-width="200" data-layout="standard" data-action="like" data-size="large" data-show-faces="true"
                     data-share="true"></div>
            </div>
        </div>
</div>
    ...
    <div class='container'>
        ...
        <div class="row">
            ...
            <div class="col-md-3 yomer-text-center">
                ...
                <p>
                    Guides and reviews for modules new and old, as well as our own worlds! Check out our new<a
                            href="AdventureLibrary/homebrew/swordcoast/swordcoast.php"> homebrew</a> variant of the
                    Sword Coast!
                </p>
                <!--                    <p>-->
            ...
            <div class="col-md-3 yomer-text-center">
                ...
                <p>
                    We're currently working on our first <a href="Threads/index.php">forum page</a>! Want to be our
                    first moderator? Awesome! Email us at contactcritwin@gmail.com to learn more.
                </p>
                <!--                    <p>-->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 yomer-text-center">
                ...
                <p class="bigtext">The website is really starting to come togethor. We now have an experimental <a
                            href="Threads/index.php">threads/forums page</a> for you guys to check out!
                    Feel free to make an account and post away! Need an account? Make one <a
                            href="loginforms/signup.php">here</a>.</p>
...
<section class="social " id='social'>
    <div class="container">
        <div class="row" align="center">
            <div class="fb-like" data-href="https://facebook.com/critwin" data-width="200" data-layout="standard"
