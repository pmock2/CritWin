...
<div id="mySidenav_right" class="sidenav_right" style="z-index: 3;">
    ...
    <div class="dropdown" style="width: 100%">
        <button class="btn btn-primary dropdown-toggle dropdown_btn" type="button" data-toggle="dropdown"">Long Text
            <span class="caret"></span></button>
        <ul class="dropdown-menu" style="width: 100%">
            <li><a href="#">Short Text</a></li>
            <li><a href="#">Short Number</a></li>
            <li><a href="#">Long Number</a></li>
        </ul>
    </div>
    <h1>Background Color:</h1>
    <br>
    <input type="color" value="#00bfff" class="option_bg_color">
    <h1>Text Color:</h1>
    <br>
    <input type="color" value="#ffffff" class="option_bg_color">
    <button data-toggle="collapse" class="btn btn-warning btn-lg btn-block preview_btn" data-target="#preview">
        Preview
    </button>
    <div id="preview" class="collapse tracker_content">
            <textarea id="preview_area" class="form-control bigtext preview_text_area" rows="5"
                      placeholder="Long Text"></textarea>
    </div>
    <br>
    <button class="btn btn-default btn-lg btn-block add_btn">Add</button>
</div>
