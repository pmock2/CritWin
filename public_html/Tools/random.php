    ...
    <div class='container1'>
        <div class="row">
            <div class="col-md-12 yomer-text">
                <h2 class="redtext">Random Generator</h2>
                <p class="bigtext">
                    this is a test
                </p>
            </div>
        ...
        <div class="row">
            <button type="button" class="btn btn-primary btn-lg btn-block" >Monster</button><br>
            <button type="button" class="btn btn-success btn-lg btn-block" >Trap</button><br>
            <button type="button" class="btn btn-info btn-lg btn-block" >Item</button><br>
        </div>
    </div>
</section>
