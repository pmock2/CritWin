...
$varfield = "Login";
$dropfield = "Login";
$link = "http://critwin.com/loginforms/StraightToLogin.php";
...
$header = "<div class=\"nav\">
    ...
    <ul class=\"menu\">
        <li class=\"btMenu\">
            ...
            <a href=\"javascript:void(0)\"><b class='whitetext' style='font-size: large; color: white'>☰ MENU</b></a></li>
        
        <li class=\"menuItem\"><a href=\"http://critwin.com\">Home</a></li>
        <li class=\"menuItem\"><a href=\"loginforms/StraightToLogin.php\"><b> $varfield </b></a></li>
        <li class=\"menuItem\">
            <div class=\"dropdown\">
