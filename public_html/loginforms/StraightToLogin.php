...
<head>
    ...
    <script>
        ...
        function login(){
            ...
            if(e == "" || p == ""){
                _("status").innerHTML = '<strong style="color:#F00;"><br>Please fill out all fields</strong>';
            } else {
                _("loginbtn").style.display = "none";
                _("status").innerHTML = 'please wait ...';
                 ajax = ajaxObj("POST", "login.php");
                ajax.onreadystatechange = function() {
                    if(ajaxReturn(ajax) == true) {
                        var response = ajax.responseText;
                        var fail = "login_failed";
                        if(fail === response.trim()){
                            _("status").innerHTML = '<strong style="color:#F00;"><br>Incorrect username or password</strong>';
...
//                            
        ...
        function signup() {
            ...
            var status = _("status");
            if (u == "" || e == "" || p1 == "" || p2 == "") {
                status.innerHTML = '<strong style="color:#F00;"><br>Usernames must begin with a letter</strong>';
            } else if (p1 != p2) {
                status.innerHTML = '<strong style="color:#F00;"><br>Your passwords do not match</strong>';
...
//            }
                ...
                ajax.onreadystatechange = function () {
                    if (ajaxReturn(ajax) == true) {
                        ...
                        if (response != "Please check your email to verify your account") {
                            status.innerHTML = ajax.responseText;
                            _("signupbtn").style.display = "block";
                        } else {
                            window.scrollTo(0, 0);
                            _("signupform").innerHTML = "Okay " + u + ", check your email inbox at <u>" + e + "</u> to complete the sign up process by activating your account.";
                        }
                    }
                };
        ...
        function checkusername() {
            ...
            if (u != "") {
                ...
                var ajax = ajaxObj("POST", "StraightToLogin.php");
                ajax.onreadystatechange = function () {
                    if (ajaxReturn(ajax) == true) {
        ...
        <div id="login">
            ...
            <form id="loginform" onsubmit="return false;">
                ...
                <div class="field-wrap">
                    ...
                    <input type="text" id="email" onfocus="emptyElement('status')" maxlength="88" autocomplete="off">
                </div>
                ...
                <div class="field-wrap">
                    ...
                    <input type="password" id="password" onfocus="emptyElement('status')" maxlength="100000" autocomplete="off">
                </div>

                <p class="forgot"><a href="forgot_pass.php">Forgot Password?</a></p>
                <p><a href="signup.php"><b>Not a member?</b></a></p>
        ...
        <div id="signup">
            ...
            <form name="signupform" id="signupform" onsubmit="return false;">
                ...
                <div class="field-wrap">
                    ...
                    <input type="email" id="email" required autocomplete="off" onfocus="emptyElement('status')"
                ...
                <div class="field-wrap">
                    ...
                    <input type="text" id="username" required autocomplete="off" onblur="checkusername()"
                ...
                <div class="field-wrap">
                    ...
                    <input type="password" id="pass1" required autocomplete="off" onfocus="emptyElement('status')"
                           maxlength="160"/>
                </div>
                ...
                <div class="field-wrap">
                    ...
                    <input type="password" id="pass2" required autocomplete="off" onfocus="emptyElement('status')"
                           maxlength="160"/>
                </div>

                <button id="signupbtn" onclick="signup()" class="button button-block">Let's Roll</button>

                <span class="whitetext" id="status"></span>
            </form>
